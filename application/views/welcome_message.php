            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-wrap">
                            <form class="row g-3 needs-validation" novalidate action="dologin" method="post">
                                <div class="col-md-12">
        ...
        <div class="modal fade" id="Signup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-wrap">
                            <form class="row g-3 needs-validation" novalidate action="savedata"  method="post">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" id="validationCustom06" name="phoneNumber" value=""
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="email" class="form-control" id="validationCustom03" name="Emailid" value=""
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
